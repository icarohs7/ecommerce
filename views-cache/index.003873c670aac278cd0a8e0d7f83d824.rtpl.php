<?php if(!class_exists('Rain\Tpl')){exit;}?><div class='slider-area'>
	...
	<div class='block-slider block-slider4'>
		<ul class=''
		    id='bxslider-home4'>
			<li>
				<img src='/res/site/img/h4-slide.png'
				     alt='Slide'>
			...
			<li><img src='/res/site/img/h4-slide2.png'
			         alt='Slide'>
				<div class='caption-group'>
					<h2 class='caption title'>
			...
			<li><img src='/res/site/img/h4-slide3.png'
			         alt='Slide'>
				<div class='caption-group'>
					<h2 class='caption title'>
			...
			<li><img src='/res/site/img/h4-slide4.png'
			         alt='Slide'>
				<div class='caption-group'>
					<h2 class='caption title'>
						Apple <span class='primary'>Store <strong>Ipod</strong></span>
					...
					<div class='product-carousel'>
						<div class='single-product'>
							<div class='product-f-image'>
								<img src='/res/site/img/product-1.jpg'
								     alt=''>
						...
						<div class='single-product'>
							<div class='product-f-image'>
								<img src='/res/site/img/product-3.jpg'
								     alt=''>
								<div class='product-hover'>
									<a href='#'
									   class='add-to-cart-link'><i class='fa fa-shopping-cart'></i> Add to cart</a>
						...
						<div class='single-product'>
							<div class='product-f-image'>
								<img src='/res/site/img/product-4.jpg'
								     alt=''>
								<div class='product-hover'>
									<a href='#'
									   class='add-to-cart-link'><i class='fa fa-shopping-cart'></i> Add to cart</a>
						...
						<div class='single-product'>
							<div class='product-f-image'>
								<img src='/res/site/img/product-5.jpg'
								     alt=''>
								<div class='product-hover'>
									<a href='#'
									   class='add-to-cart-link'><i class='fa fa-shopping-cart'></i> Add to cart</a>
						...
						<div class='single-product'>
							<div class='product-f-image'>
								<img src='/res/site/img/product-6.jpg'
								     alt=''>
								<div class='product-hover'>
									<a href='#'
									   class='add-to-cart-link'><i class='fa fa-shopping-cart'></i> Add to cart</a>
